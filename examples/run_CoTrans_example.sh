...
# Example of how to run R2D2 on a cotranscriptional SHAPE-Seq data set
...
python ../analyze_cotrans_SHAPE-Seq.py --in_dir "$cwd/reactivities_3/" --out_dir "$cwd/CoTrans_example_output/" --adapter "CTGACTCGGGCACCAAGG" --e 100 --endcut 0 --constrained_c "2.6" --scale_rho_max "2.3" --draw_all "False" --most_count_tie_break "False" --weight_paired "0.3" --scaling_func "K" --cap_rhos "True" --pol_fp 15 --p 1

#python ../analyze_cotrans_SHAPE-Seq.py --in_dir "$cwd/6033_SRP/" --out_dir "$cwd/CoTrans_example_output_6033_SRP/" --adapter "CTGACTCGGGCACCAAGG" --e 100 --endcut 0 --constrained_c "2.6" --scale_rho_max "2.3" --draw_all "False" --most_count_tie_break "False" --weight_paired "0.3" --scaling_func "K" --cap_rhos "True" --pol_fp 15 --p 1
