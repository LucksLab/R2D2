...
python ../analyze_cotrans_SHAPE-Seq.py --in_dir "$cwd/reactivities_1/" --out_dir "$cwd/CoTrans_example_output_1/" --adapter "CTGACTCGGGCACCAAGG" --e 10 --endcut 0 --constrained_c "1.8" --scale_rho_max "1.8" --draw_all "False" --most_count_tie_break "False" --weight_paired "0.5" --scaling_func "K" --cap_rhos "True" --pol_fp 14 --p 1
